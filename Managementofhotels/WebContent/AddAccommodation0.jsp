...
<FORM NAME="Locations" ACTION="AddAccommodation1.jsp" OnSubmit="return validate()">
 ...
 <center>
 <TABLE width="20%" class="notepad">
		<TR class="row_title">
		  <TH align="center" colspan=3><FONT SIZE="5" COLOR="#AA2504" face='monotype corsiva'>Add New Location</FONT></TH>
		</TR>
		<Input type=hidden name=UserID value='<%=UserID%>'>
		<tr class=row_odd>
		  <TD align="left" width="40%"><FONT SIZE="5" COLOR="#AA2504" face='monotype corsiva'>Location Name </FONT><FONT COLOR="red">*</FONT></TD>
		  <TD colspan=2 align=left><Input type=text name='LocationName' value=''></TD></tr>
		  <tr class=row_even>
		  <TD align="left"><FONT SIZE="5" COLOR="#AA2504" face='monotype corsiva'>Location Image </FONT><FONT COLOR="red">*</FONT></TD>
		...
		<div id="infodiv"></div><Input type="text" name='PhotoPath' ><INPUT id="FUBtn" name="FUBtn" class= "UploadButton" TYPE="Button" value='Attach PhotoPath' onclick="fnUpload()" class="UploadButton"><br>
		  ...
		  <tr class=row_odd><TD align="left"><FONT SIZE="5" COLOR="#AA2504" face='monotype corsiva'>Location Description<FONT COLOR="red">*</FONT></TD>
		  <TD align=left><textarea name='LocationDesc' ROWS="10" COLS="20"value='' ></textarea></TD>
		  <td><FONT SIZE="4" COLOR="#AA2504" face=''><B>Place info about location  here </B></Font></td>
		  </tr>
