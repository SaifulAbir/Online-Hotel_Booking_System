...
<%
	...
	try{
		...
		%>
			<TR class= "row_even">
			<td align="left" colspan=2><B>RegID: </B><%=RegID%></td><td align="left" colspan=2><a href ="Block.jsp?UserID=<%=UserID%>&RegID=<%=RegID%>"><IMG SRC="Images/Block.jpg" WIDTH="123" HEIGHT="31" BORDER="0" ALT=""></a></td></tr>
