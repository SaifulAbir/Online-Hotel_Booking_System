...
<h2 align=center>Member Speak</h2>
<P align=center><FONT SIZE="6" COLOR="#AA2504" face='monotype corsiva'>Share your memories with us!<BR></FONT>
</P>
<form method="POST" name="FeedbackForm"  onsubmit="return goURL()">
<table align=center width="60%">
<tr class="row_title">
    
<TH align="center" colspan=2><FONT SIZE="5" COLOR="#AA2504" face='monotype corsiva'>Member Reviews</FONT></TH>
		</TR>
<tr class="row_odd">
    <td><font size="5">User ID</font> <FONT COLOR="#FF0000">*</FONT></td>
    <td><B><INPUT TYPE="text" NAME="From" value='<%=UserID%>'size="50" readonly></B></td>
</tr>
<tr class="row_odd">
    <td><font size="5">Testimonial</font> <FONT COLOR="#FF0000">*</FONT></td>
