...
<FORM NAME="DepositAmount" ACTION="DepositAmount1.jsp" OnSubmit="return validate()">
 ...
 <TABLE width="40%" class="notepad">
		<TR class="row_title">
		  <TH align="center" colspan=2><FONT SIZE="5" COLOR="#AA2504" face='monotype corsiva'>Provide your Credit Card details </FONT></TH>
		</TR>
		<tr class=row_odd>
		  <TD align="left"><FONT SIZE="5" COLOR="#AA2504" face='monotype corsiva'>Credit Card Number</FONT><FONT COLOR="red">*<td align=left><input type=text name=cardnum></FONT></TD>
		</tr>
		<tr class=row_even><TD align="left"><FONT SIZE="5" COLOR="#AA2504" face='monotype corsiva'>PIN<FONT COLOR="red">*</FONT></TD>
		  <TD align=left><input type=password name=pin></TD>
		</tr>
		<tr class=row_odd><TD align="left"><FONT SIZE="5" COLOR="#AA2504" face='monotype corsiva'>Amount<FONT COLOR="red">*</FONT></TD>
