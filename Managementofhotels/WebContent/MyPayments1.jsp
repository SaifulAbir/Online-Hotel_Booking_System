...
<%
	...
	try{
		...
		%><tr></tr><tr></tr><tr></tr><tr></tr>
			...
			<td align="left" colspan=2> <FONT SIZE="5" COLOR="#A70C42"><B>Tk.<%=RoomCharges%></B></FONT></td></tr>
			...
			if(rCount!=0)
		{
			...
			<TR class= "row_odd">
			<td align="left" colspan=2><B><FONT SIZE="5" COLOR="#330000">Total Amount Paid:</FONT> </B></td>
			<td align="left" colspan=2> <FONT SIZE="5" COLOR="#A70C42"><B>Tk.<%=Amount%></B></FONT></td></tr>
			<%
			}
