...
<script>alert("Depositing money before booking can help us to serve first.");</script>
<FORM NAME="BookNow"  OnSubmit="return validate()" ACTION="BookNow1.jsp" >
	
 <center>
 <TABLE width="45%">
		<TR class="row_title">
		  <TH align="center" colspan=3><FONT SIZE="6" COLOR="#AA2504" face='monotype corsiva'>Book Now</FONT></TH>
		</TR>
		<Input type=hidden name='ResortID' value='<%=ResortID%>' readonly>
		<Input type=hidden name='LocationName' value='<%=LocationName%>' readonly>
		<tr class=row_odd>
		  <TD align="left"><FONT SIZE="5" COLOR="#AA2504" face='monotype corsiva'>RoomID </FONT><FONT COLOR="red">*</FONT></TD>
		  <TD colspan=2><Input type=text name='RoomID' value='<%=RoomID%>' readonly></TD></tr>
		
		<tr class=row_even>
		  <TD align="left"><FONT SIZE="5" COLOR="#AA2504" face='monotype corsiva'>UserID </FONT><FONT COLOR="red">*</FONT></TD>
		  <TD colspan=2><Input type=text name='UserID' value='<%=UserID%>' readonly></TD></tr>		 
		<tr class=row_odd>
		  <TD align="left"><FONT SIZE="5" COLOR="#AA2504" face='monotype corsiva'>Member Type  </FONT><FONT COLOR="red">*</FONT></TD>
		  <TD colspan=2>		  <Input type=text name='MemberType' value='<%=MemberType%>' readonly> 
</td></tr>
		<tr class=row_even>
		  <TD align="left"><FONT SIZE="5" COLOR="#AA2504" face='monotype corsiva'>Actual Charge  </FONT><FONT COLOR="red">*</FONT></TD>
		  
		<TD colspan=2><Input type=text name='ActualCharge' value='<%=RoomCharges%>' readonly><span>Tk</span></td></tr>
		<tr class=row_even>
		  <TD align="left"><FONT SIZE="5" COLOR="#AA2504" face='monotype corsiva'>Net Room Charges  </FONT><FONT COLOR="red">*(incl VAT and with discount)</FONT></TD>
		  
		<TD colspan=2><Input type=text name='RoomRent' value='' readonly ></td></tr>
		
		<TR class=row_even>
				<TD align="left"><FONT SIZE="5" COLOR="#AA2504" face='monotype corsiva'>From</Font><FONT COLOR="red">*</FONT></TH>
		...
		<TR class=row_odd>
				<TD align="left"><FONT SIZE="5" COLOR="#AA2504" face='monotype corsiva'>To</Font><FONT COLOR="red">*</FONT></TH>
