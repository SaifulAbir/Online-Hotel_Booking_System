...
{%><B>Television<br></B><%}else{%>
			...
			<td align="left" colspan=2><a href ="BookNow0.jsp?RoomID=<%=RoomID%>&RoomCharges=<%=RoomCharges%>&LocationName=<%=LocationName%>&ResortID=<%=ResortID%>"><IMG SRC="Images/BookNow.jpg" WIDTH="124" HEIGHT="29" BORDER="0" ALT="BookNow"></a></tr>
