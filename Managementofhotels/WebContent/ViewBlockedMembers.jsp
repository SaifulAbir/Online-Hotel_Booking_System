...
<%
	...
	try{
		...
		%>
			<TR class= "row_even">
			<td align="left" colspan=2><B>RegID: </B><%=RegID%></td><td align="left" colspan=2><a href ="UnBlock.jsp?UserID=<%=UserID%>&RegID=<%=RegID%>"><IMG SRC="Images/UnBlock.jpg" WIDTH="140" HEIGHT="31" BORDER="0" ALT=""></a></td></tr>
